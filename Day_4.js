// Puzzle Input (sanitize by splitting on new lines to create array, and then replace line breaks with spaces within each 'line')
...
/**
 * Puzzle 1 - The Passport Processing is going slowly because some people brought North Pole ID...
 *  - Create a validator to count the number of valid IDs in the list
 *
 * @param {Array} passportList list of passport/ID information
 * @returns {Number} integer number of valid passports
 */
